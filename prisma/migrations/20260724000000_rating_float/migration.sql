...
INSERT INTO "new_Series" ("createdAt", "currentEpisode", "currentSeason", "id", "name", "posterPath", "rating", "status", "tmdbId", "updatedAt", "userId", "year") SELECT "createdAt", "currentEpisode", "currentSeason", "id", "name", "posterPath", "rating", "status", "tmdbId", "updatedAt", "userId", "year" FROM "Series";
DROP TABLE "Series";
